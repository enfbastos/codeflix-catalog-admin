...
class TestListAPI:
    def test_list_cast_members(self, actor: CastMember, director: CastMember, repository: DjangoORMCastMemberRepository) -> None:
...
@pytest.mark.django_db
class TestCreateAPI:
    def test_when_request_data_is_valid_then_create_cast_member(self, repository: DjangoORMCastMemberRepository) -> None:
        ...
        saved_cast_member = repository.get_by_id(response.data["id"])
...
@pytest.mark.django_db
class TestUpdateAPI:
    def test_when_request_data_is_valid_then_update_cast_member(self, actor: CastMember, repository: DjangoORMCastMemberRepository) -> None:
        repository.save(actor)
    ...
    def test_when_cast_member_with_id_does_not_exist_then_return_404(self) -> None:
...
class TestDeleteAPI:
    ...
    def test_when_cast_member_found_then_delete_cast_member(self, actor: CastMember, repository: DjangoORMCastMemberRepository) -> None:
        repository.save(actor)
