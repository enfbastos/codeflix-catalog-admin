...
class TestGetById:
    def test_can_get_cast_member_by_id(self):
        actor = CastMember(name="Marilyn Monroe", type=CastMemberType.ACTOR,)
        director = CastMember(name="Quentim Tarantino", type=CastMemberType.DIRECTOR)
...
class TestUpdate:
    def test_update_cast_member(self):
        ...
        assert updated_cast_member.name == "Angeline Jolie"
